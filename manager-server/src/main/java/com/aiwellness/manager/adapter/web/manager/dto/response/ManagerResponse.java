package com.aiwellness.manager.adapter.web.manager.dto.response;
...
public class ManagerResponse {
    ...
    @Schema(description = "이메일 주소", example = "manager@example.com")
    private String email;
    
    @Schema(description = "매니저 이름", example = "매니저")
    private String name;
    ...
    public static ManagerResponse from(com.aiwellness.manager.domain.model.manager.Manager manager) {
