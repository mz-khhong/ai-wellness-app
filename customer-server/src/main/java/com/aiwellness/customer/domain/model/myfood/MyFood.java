package com.aiwellness.customer.domain.model.myfood;
...
/**
 * com.aiwellness.customer.domain.model.myfood
 * <p>
 * MyFood
 * <p>
 * MY FOOD 도메인 모델
 * <p>
 * 데이터베이스 테이블: my_foods (1:1 매핑)
 *
 * @author 메가존 시스템
 * @version 1.0
 * @since 2025. 11. 18.
...
@AllArgsConstructor
@Schema(
    description = "MY FOOD 도메인 모델 (테이블: my_foods)",
    example = "MyFood(id=1, customerId=1, facilityGroupId=1)"
)
public class MyFood {
    
    @Schema(
        description = "MY FOOD ID (Primary Key, 컬럼: id)",
        example = "1"
    )
    private Long id;
